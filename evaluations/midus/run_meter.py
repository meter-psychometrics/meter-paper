"""Score the MIDUS MIDI Big Five battery with the frozen supplied-structure model.
...
if __name__ == "__main__":
    ...
    main(factor_map=factor_map, metadata={"data_provenance": "real", "construct": "personality"})
